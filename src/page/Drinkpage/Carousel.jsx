...
function MyCarousel2() {
  ...
  return (
    <section className="mt-10 lg:mt-[50px]">
      <Title className="hidden lg:flex items-center justify-start text-start lg:text-center md:text-5xl lg:mt-20 mt-7 mb-2 pl-24 ">
        See How People are Chilling On Chillsbay
      </Title>

   
        <Title className=" lg:hidden flex text-start    mb-2 px-8 ">
      Upcoming events <br/> this weekends
      </Title>
