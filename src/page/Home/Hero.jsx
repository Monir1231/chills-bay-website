...
import hero1 from '/chills-bay-website/public/hero.png'


function Hero() {
  return (
    <section  style={{ backgroundImage: `url(${hero1})` }} className="lg:bg-[url('public/hero.png')] bg-[url('public/mobile.png')]  bg-no-repeat bg-center bg-cover lg:py-28 md:py-24 py-16 lg:text-start text-center">
